...
public class PersonaController {
    ...
    public ResponseEntity<?> loginEmail(@RequestBody GeneralRequest request) throws Exception {
        EstudianteClienteResponse response = personaService.loginByEmail(request);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
